...
var amenityRules = []amenityRule{
	{[]string{"холодильник"}, "Холодильник", groupInside},
	{[]string{"микроволнов"}, "Микроволновка", groupInside},
	{[]string{"индукцион", "варочная панель", "плита"}, "Плита", groupInside},
	{[]string{"чайник"}, "Чайник", groupInside},
	{[]string{"посуд", "кухонн", "кухня", "тостер"}, "Посуда и кухонная утварь", groupInside},
	...
	{[]string{"колонк", "станция", "алиса"}, "Колонка", groupInside},
	{[]string{"набор продукт", "приветственный набор", "чай, соль"}, "Стартовый набор продуктов", groupInside},
