...
func TestRegion(t *testing.T) {
	cases := []struct{ name, address, want string }{
		{"область", "Ивановская обл., Иваново, пр-т Ленина", "Ивановская обл."},
		{"полное слово", "Московская область, Клин", "Московская область"},
		{"край", "Краснодарский край, Сочи", "Краснодарский край"},
		{"республика", "Респ. Карелия, Сортавала", ""},
