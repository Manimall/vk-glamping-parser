...
func TestPriceFromDesc(t *testing.T) {
	cases := map[string]string{
		...
		"Баня бочка до 4х человек-5000 рублей в час":    "5 000 ₽/час",
		"стоимость 1200 руб. в час., минимально 3 часа": "1 200 ₽/час",
		"Доплата 3000 рублей до 3 кг собачки":           "3 000 ₽",
		"Оплата 2000 ₽ единоразово":                     "2 000 ₽",
		// «р.» с точкой: \b в Go ASCII-only — раньше «6000р.» терялся.
		"Растопка 6000р.":       "6 000 ₽",
		"Доплата 1500р в сутки": "1 500 ₽",
		// цена без валюты: почасовая и сеанс.
		"Стоимость 2500/час аренда от 2 часов": "2 500 ₽/час",
		"Стоимость сеанса от 15000/3 часа":     "15 000 ₽ за 3 ч",
		"Банный комплекс от 3900/час":          "3 900 ₽/час",
		"Стоимость сеанса 10000":               "10 000 ₽",
		"350":                                  "350 ₽", // desc из одного числа
...
func TestDetailPaidExtras(t *testing.T) {
	...
	if byName["Можно с Питомцем"] != "1 500 ₽" || byName["Баня"] != "5 000 ₽/час" {
