...
// враньём: разбор вёрстки давно перестал находить это число (слова
// «Вместимость» в разметке источника нет), и дефолт стоял у 620 объектов из
// 622 — при реальном разбросе от двух гостей до двадцати четырёх. Гость видел
